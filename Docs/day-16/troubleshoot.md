# Day 16: Collaborative Learning Features - Troubleshooting Guide

## 🔧 Common Issues and Solutions

This guide covers common problems you might encounter during Day 16.
...
2. **Verify Django Channels running**:
```bash
# Make sure you're running with Daphne, not runserver
daphne -b 0.0.0.0 -p 8000 shikshaAI.asgi:application
```

3. **Check consumer routing**:
```python
# routing.py
websocket_urlpatterns = [
    re_path(r'ws/chat/$', ChatConsumer.as_asgi()),  # Correct
    # path('ws/chat/', ChatConsumer.as_asgi()),  # May not work
]
```
...
4. **Check Day 15**: Ensure previous day completed correctly
